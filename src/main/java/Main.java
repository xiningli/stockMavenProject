...
public class Main {
    ...
    public static void main(String[] args) {
     ...
     //   String userStockNameInMind;

        spark.Spark.get("/stocksearch", (req, res) -> {
            try {

                map.put("stockNameSearchTableHTML", ParseHtmlTable.getHtmlTab(req.queryParams("userStockNameInMind")));
                System.out.println("-----------------------------------------------------------");
                System.out.println(req.queryParams("userStockNameInMind"));
                System.out.println(ParseHtmlTable.getHtmlTab(req.queryParams("userStockNameInMind")));
                return new ModelAndView(map, "stockKeySearch.mustache");
//                return "<p>The current relative path is: " + s + " with stockkeys:" + req.queryParams("stockkeys") + " and API key: " + req.queryParams("apikey") + "</p>" +
                ...
                e.printStackTrace();
                return new ModelAndView(map, "stockKeySearchFailed.mustache");
                //               return "<p>The current relative path is: " + s + " with stockkeys:" + req.queryParams("stockkeys") + "and API key: " + req.queryParams("apikey") + "</p>" +
